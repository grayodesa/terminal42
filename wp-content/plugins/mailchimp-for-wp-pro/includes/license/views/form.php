	...
	<tbody>
		...
		<tr valign="top">
			...
			<td>
				...
				<p class="help">
					<?php
					echo sprintf( __( 'The license key you got when purchasing the plugin. <a href="%s">Find your license key here</a>', 'mailchimp-for-wp' ), $product->get_tracking_url( '/account/' ) );
