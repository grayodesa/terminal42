...
class MC4WP_Product extends DVK_Product {
	 ...
	 */
	public $item_name = 'MailChimp for WordPress Pro';
	 ...
	 */
	public $license_page_url = 'admin.php?page=mailchimp-for-wp';
	...
	public function __construct() {
		$this->plugin_basename = plugin_basename( MC4WP_PLUGIN_FILE );
		$this->slug = basename( dirname( MC4WP_PLUGIN_FILE ) );
