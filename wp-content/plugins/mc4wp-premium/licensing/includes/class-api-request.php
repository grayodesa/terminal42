...
if( ! class_exists( 'DVK_API_Request', false ) ) {

	/**
	* Handles requests to the mc4wp.com EDD API
	*/
	class DVK_API_Request {
		...
		*/
		public function __construct( $url, array $args = array() ) {
			...
			// filter some args
			$this->args['sslverify'] = apply_filters( 'mc4wp_use_sslverify', true );
