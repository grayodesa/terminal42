...
'http://actualityextensions.com/updates/server/?action=get_metadata&slug=woocommerce-point-of-sale', __FILE__ , 'woocommerce-point-of-sale'
);
...
function WC_POS () {
	$instance = WC_POS::instance( __FILE__, '3.1.4' );
	return $instance;
}
