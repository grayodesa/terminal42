...
<div id="woocommerce-order-items">
		...
		<table cellspacing="0" cellpadding="0" class="woocommerce_order_items wp-list-table">
			<thead>
				<tr>
					...
					<th class="item sortable" colspan="2" data-sort="string-ins"><?php _e( 'Item', 'wc_point_of_sale' ); ?></th>
					...
					<th class="line_cost sortable" data-sort="float"><?php _e( 'Barcode Preview', 'wc_point_of_sale' ); ?></th>
	...
	<div class="wc-order-data-row wc-order-bulk-actions wc-order-data-row-toggle">
		<button type="button" class="button bulk-delete-items" style="display:none;"><?php _e( 'Delete Selected Row(s)', 'wc_point_of_sale' ); ?></button>
		<button type="button" class="button bulk-add-variations" style="display:none;"><?php _e( 'Add all variations', 'woocommerce' ); ?></button>
		<button class="button add-line-item" type="button"><?php _e( 'Add product', 'wc_point_of_sale' ); ?></button>
		<button class="button add-line-item-category" type="button"><?php _e( 'Add product category', 'wc_point_of_sale' ); ?></button>
		...
		<div class="wc-backbone-modal">
			<div class="wc-backbone-modal-content">
				<section class="wc-backbone-modal-main" role="main">
					...
					<footer>
						<div class="inner">
							<button id="add_products" class="button button-primary button-large"><?php _e( 'Add', 'woocommerce' ); ?></button>							
						</div>
					</footer>
				</section>
			</div>
