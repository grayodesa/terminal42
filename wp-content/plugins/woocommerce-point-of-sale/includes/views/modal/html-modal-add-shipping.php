            ...
            <div class="two_cols">
                ...
                <div class="col-2">
                    <div class="custom-shipping-fields">
                        <h3>
                            <input type="checkbox" value="1" id="custom-add-shipping-details" class="input-checkbox" style="margin: 5px 10px 5px 0;">
                            <label class="checkbox" for="custom-add-shipping-details"><?php _e( 'Add shipping details', 'woocommerce' ); ?></label>
                        </h3>
