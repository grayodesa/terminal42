...
<div class="md-modal full-width md-dynamicmodal" id="modal-order_customer">
    <div class="md-content woocommerce">
        ...
        <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
            <a href="#pos_billing_details" class="nav-tab nav-tab-active"><?php _e( 'Billing Details', 'wc_point_of_sale' ); ?></a>
            <a href="#pos_shipping_details" class="nav-tab"><?php _e( 'Shipping Details', 'wc_point_of_sale' ); ?></a>
            <a href="#pos_additional_fields" class="nav-tab" <?php echo !$a ? 'style="display:none;"' : ''; ?> ><?php _e( 'Additional Fields', 'wc_point_of_sale' ); ?></a>
            <a href="#pos_custom_fields" class="nav-tab" <?php echo !$c ? 'style="display:none;"' : ''; ?>><?php _e( 'Custom Fields', 'wc_point_of_sale' ); ?></a>
            <a href="#pos_order_fields" class="nav-tab" <?php echo !$o ? 'style="display:none;"' : ''; ?>><?php _e( 'Custom Order Fields', 'wc_point_of_sale' ); ?></a>
        </h2>
