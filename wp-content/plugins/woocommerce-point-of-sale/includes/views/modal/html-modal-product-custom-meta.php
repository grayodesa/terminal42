<div class="md-modal full-width md-dynamicmodal" id="modal-add_product_custom_meta">
    <div class="md-content">
                ...
                <table id="product_custom_title" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="product_is_taxable"><input type="checkbox" id="product_new_is_taxable"></td>
        ...
        <div class="wrap-button">
            <button class="button wp-button-large" id="add_product_custom_meta"><?php _e('Add Meta', 'wc_point_of_sale'); ?></button>
            <button class="button button-primary wp-button-large alignright" id="save_product_custom_meta"><?php _e('Update Product', 'wc_point_of_sale'); ?></button>
        </div>
    </div>
</div>