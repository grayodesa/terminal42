...
class WC_Pos_Receipts {
  ...
  public static function get_default_receipt_options(){
							...
							<div class="meta-box-sortables">
								<div class="postbox ">
									...
									<table id="receipt_options">
										...
										<tr>
											<td>
												<label class="receipt_labels" for="receipt_print_order_time"><?php _e( 'Print Order Date', 'wc_point_of_sale' ); ?></label>
											</td>
											<td>
										...
										<tr class="show_receipt_print_order_time">
											<td>
												<label class="receipt_labels" for="receipt_order_date_format"><?php _e( 'Date Format', 'wc_point_of_sale' ); ?></label>
											</td>
											<td>
												<?php
										...
										<tr class="show_receipt_print_server">
											...
											<td>
												<select id="receipt_served_by_type" name="receipt_served_by_type">
								...
								<div class="postbox ">
									...
									<div class="inside">
										<table id="customer_details">
											<tr>
												<td>
													<label class="receipt_labels" for="receipt_print_order_notes"><?php _e( 'Print Order Notes', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="checkbox" id="receipt_print_order_notes" value="yes" name="receipt_print_order_notes" <?php echo ($receipt_options['print_order_notes'] == 'yes')? 'checked="checked"' : ''; ?>>
												</td>
											</tr>
											<tr class="show_receipt_print_order_notes">
												<td>
													<label class="receipt_labels" for="receipt_order_notes_label"><?php _e( 'Order Notes Label', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="text" id="receipt_order_notes_label" name="receipt_order_notes_label" value="<?php echo $receipt_options['order_notes_label']; ?>">
												</td>
											</tr>
											<tr>
												<td>
													<label class="receipt_labels" for="receipt_print_customer_name"><?php _e( 'Print Customer Name', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="checkbox" id="receipt_print_customer_name" value="yes" name="receipt_print_customer_name" <?php echo ($receipt_options['print_customer_name'] == 'yes')? 'checked="checked"' : ''; ?>>
												</td>
											</tr>
											<tr class="show_receipt_print_customer_name">
												<td>
													<label class="receipt_labels" for="receipt_customer_name_label"><?php _e( 'Customer Name Label', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="text" id="receipt_customer_name_label" name="receipt_customer_name_label" value="<?php echo $receipt_options['customer_name_label']; ?>">
												</td>
											</tr>
											<tr>
												<td>
													<label class="receipt_labels" for="receipt_print_customer_email"><?php _e( 'Print Customer Email', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="checkbox" id="receipt_print_customer_email" value="yes" name="receipt_print_customer_email" <?php echo ($receipt_options['print_customer_email'] == 'yes')? 'checked="checked"' : ''; ?>>
												</td>
											</tr>
											<tr class="show_receipt_print_customer_email">
												<td>
													<label class="receipt_labels" for="receipt_customer_email_label"><?php _e( 'Customer Email Label', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="text" id="receipt_customer_email_label" name="receipt_customer_email_label" value="<?php echo $receipt_options['customer_email_label']; ?>">
												</td>
											</tr>
											<tr>
												<td>
													<label class="receipt_labels" for="receipt_print_customer_ship_address"><?php _e( 'Print Shipping Address', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="checkbox" id="receipt_print_customer_ship_address" value="yes" name="receipt_print_customer_ship_address" <?php echo ($receipt_options['print_customer_ship_address'] == 'yes')? 'checked="checked"' : ''; ?>>
												</td>
											</tr>
											<tr class="show_receipt_print_customer_ship_address">
												<td>
													<label class="receipt_labels" for="receipt_customer_ship_address_label"><?php _e( 'Shipping Address Label', 'wc_point_of_sale' ); ?></label>
												</td>
												<td>
													<input type="text" id="receipt_customer_ship_address_label" name="receipt_customer_ship_address_label" value="<?php echo $receipt_options['customer_ship_address_label']; ?>">
												</td>
											</tr>
										</table>
									</div>
	...
	{
		$elems = 'body.pos_receipt, table.order-info, table.customer-info, table.receipt_items, #pos_receipt_title, #pos_receipt_address, #pos_receipt_contact, #pos_receipt_header, #pos_receipt_footer, #pos_receipt_tax, #pos_receipt_info, #pos_receipt_items';
		$templates = array(
			'text_size'                    => array(
