...
class WC_Pos_Registers{
	...
	<div class="wrap nosubsub" id="wc-pos-registers">
    	...
    	<form method="get" action="" class="search-form">
			<p class="search-box">
				<label for="register-search-input" class="screen-reader-text"><?php _e( 'Search Registers', 'wc_point_of_sale' ); ?></label>
				<input type="hidden" value="wc_pos_registers" name="page">
				<input type="search" value="" name="s" id="register-search-input">
				<input type="submit" value="<?php _e( 'Search Registers', 'wc_point_of_sale' ); ?>" class="button" id="search-submit" name="">
			</p>
			...
			<div id="sale_report_overlay" class="overlay_order_popup" style="display: block;">
			    <div id="sale_report_popup">
					...
					<div class="media-frame-footer">
			        	<a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page='.WC_POS_TOKEN.'-print&print=report&report=' . $rg_id ), 'print_pos_report' ); ?>" class="button alignright" target="_blank">Print</a><br class="clear">
			        </div>
			    </div>
			</div>
			<?php
					...
					<div class="col-wrap">
						...
						<div class="form-wrap">
							...
							<form id="add_wc_pos_registers" class="validate" action="" method="post">
								...
								?>
								<p class="submit"><input type="submit" value="<?php _e( 'Add New Register', 'wc_point_of_sale' ); ?>" class="button button-primary" id="submit" name="submit"></p>
							</form>
						</div>
					</div>
		<?php
