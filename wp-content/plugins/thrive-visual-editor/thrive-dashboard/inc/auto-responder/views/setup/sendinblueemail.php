...
<div class="tvd-row">
	<div class="tvd-col tvd-s12">
		<p class="tve-form-description tvd-note-text">
			...
			<a href="https://resources.sendinblue.com/en/francais-mon-compte-sendinblue-smtp-nest-pas-active-comment-faire/" target="_blank"><?php echo __( 'Learn more', TVE_DASH_TRANSLATE_DOMAIN ) ?></a>.
		</p>
	</div>
</div>
