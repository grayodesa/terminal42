...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<p><strong><?php echo __( 'Notification:', TVE_DASH_TRANSLATE_DOMAIN ) ?> </strong><?php echo __( 'Mail Relay limits the number of emails sent per minute to 2. All emails sent after this limit will be discarded', TVE_DASH_TRANSLATE_DOMAIN ) ?></p>
	</form>
</div>
