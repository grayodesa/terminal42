	...
	<tr>
		...
		<td width="60%">
			<div class="tve_lightbox_text_holder">
				<input type="text" name="event_tooltip_text" id="tve_event_tooltip_text"
				       class="tve_ctrl_validate tve_lightbox_input" data-validators="required;"
				       value="<?php echo isset( $this->config['event_tooltip_text'] ) ? $this->config['event_tooltip_text'] : ''; ?>"/>
			</div>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<div class="tve_lightbox_preview_holder">
				<a href="javascript:void(0)" class="tve_preview_hover tve_tooltip_anchor tve_ea_underline_<?php echo isset( $this->config['event_tooltip_decoration'] ) ? $this->config['event_tooltip_decoration'] : 'solid'; ?>"
				   data-tooltip-position="<?php echo isset( $this->config['event_tooltip_position'] ) ? $this->config['event_tooltip_position'] : 'top'; ?>"
				   data-tooltip-text="<?php echo isset( $this->config['event_tooltip_text'] ) ? $this->config['event_tooltip_text'] : ''; ?>"
...
<script type="text/javascript">
	jQuery( document ).ready( function ( $ ) {
		...
		$('#tve_event_tooltip_text').on('change', function() {
