...
* 100% hacker safe - by design of MPK it is impossible for hacker to steal your bitcoins even if your whole server and database is compromised and hacked.
...
= 4.07 =
* Fixed: DB schema type adjusted to prevent occasional record loss.
* Added: Option to autocomplete paid orders. Email will be sent to customer upon full payment received.
* Added: Email will be sent to admin upon full payment received.

= 4.06 =
* Fixed: missing hex2bin for PHP < 5.4 in ElectrumHelper.php
         Added automatic drop-in replacement for possibly missing hex2bin
         to support earlier versions of PHP.

= 4.05 =
* Fixed: bcmath_utils.php - fixed issue with older (<5.4) PHP versions
* not supporting [] instantiation of arrays

= 4.04 =
* Fixed: bug in saving data within WooCommerce settings
* Fixed: issue with curl

= 4.02 =
* Fixed: Support for Electrum 2.x Master Public Key
* Added: New, faster math processing library
