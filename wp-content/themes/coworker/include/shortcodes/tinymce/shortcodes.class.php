			...
			foreach( $this->params as $pkey => $param )
			{
				...
				switch( $param['type'] )
				{
                    ...
                    case 'color' :
						...
						// prepare
						$output  = $row_start;
						$output .= '<input class="zilla-form-text zilla-input colorpicker-input" name="'.$pkey.'" id="'. $pkey .'" type="text" value="'. $param['std'] .'" />' . "\n";
						$output .= $row_end;
				...
				foreach( $this->cparams as $cpkey => $cparam )
				{
					...
					switch( $cparam['type'] )
					{
                        ...
                        case 'color' :
							...
							// prepare
							$coutput  = $crow_start;
                            $coutput .= '<input class="zilla-form-text zilla-cinput colorpicker-input" name="'.$cpkey.'" id="'. $cpkey .'" type="text" value="'. $cparam['std'] .'" />' . "\n";
    						$coutput .= $crow_end;
