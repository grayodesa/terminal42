...
class ZillaShortcodes {
    ...
    {	
    	define('ZILLA_TINYMCE_URI', get_template_directory_uri() .'/include/shortcodes/tinymce');
		define('ZILLA_TINYMCE_DIR', SEMICOLON_FUNCTIONS .'/shortcodes/tinymce');
	...
	function admin_init()
	{
        ...
        wp_enqueue_style( 'color-picker', get_template_directory_uri() . '/include/shortcodes/tinymce/css/colorpicker.css' );
        ...
        wp_enqueue_script( 'color-picker', get_template_directory_uri() . '/include/shortcodes/tinymce/js/colorpicker.js', array('jquery') );
		wp_enqueue_script( 'zilla-popup', ZILLA_TINYMCE_URI . '/js/popup.js', false, '1.0', false );
		
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => get_template_directory_uri() . '/include/shortcodes') );
	}
