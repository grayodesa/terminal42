...
add_action( 'tgmpa_register', 'semi_theme_register_required_plugins' );

function semi_theme_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
			...
			'source'   				=> get_template_directory() . '/include/plugins/layersliderwp.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
