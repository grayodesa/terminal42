...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col_half nobottommargin address <?php echo ( ( $col = $col * -1 ) < 0 ) ? '' : 'col_last'; ?>">
		<header class="title">
			<h3><?php echo $title; ?></h3>
			<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit btn btn-mini"><?php _e( 'Edit', 'woocommerce' ); ?></a>
		</header>
		<address class="well nobottommargin">
			<?php
