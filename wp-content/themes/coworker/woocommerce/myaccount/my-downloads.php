...
if ( $downloads = $woocommerce->customer->get_downloadable_products() ) : ?>
	...
	<ul class="digital-downloads nomargin">
		<?php foreach ( $downloads as $download ) : ?>
			<li>
				<?php
					do_action( 'woocommerce_available_download_start', $download );

					echo apply_filters( 'woocommerce_available_download_link', '<a href="' . esc_url( $download['download_url'] ) . '" class="btn"><i class="icon-download-alt"></i>' . $download['download_name'] . '</a>', $download );
