...
jQuery(document).ready(function($){
	...
	$(".sidebar_add_button").live('click', function(){		
		var sidebarsContainer = $(this).prev();
		var sidebarId = sidebarsContainer.attr('id');
		
		var numArr = $('#'+sidebarId +' li').find('.order').map(function() { 
			var str = this.id; 
			str = str.replace(/\D/g,'');
			str = parseFloat(str);
			return str;			
		...
		var newSidebar = '<li class="temphide"><div class="slide_header"><strong>Sidebar ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sidebarId + '[' + newNum + '][order]" id="' + sidebarId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Sidebar Name</label><input class="slide of-input of-slider-title" name="' + sidebarId + '[' + newNum + '][title]" id="' + sidebarId + '_' + newNum + '_slide_title" value=""><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
		
		sidebarsContainer.append(newSidebar);
		var nSidebar = sidebarsContainer.find('.temphide');
		nSidebar.fadeIn('fast', function() {
			$(this).removeClass('temphide');
		});
    ...
    //Add new Custom Icon
	$(".customicon_add_button").live('click', function(){		
		var customIconsContainer = $(this).prev();
		var customIconId = customIconsContainer.attr('id');
		
		var numArr = $('#'+customIconId +' li').find('.order').map(function() { 
			var str = this.id; 
			str = str.replace(/\D/g,'');
			str = parseFloat(str);
			return str;			
		...
		var newCustomIcon = '<li class="temphide"><div class="slide_header"><strong>Icon ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + customIconId + '[' + newNum + '][order]" id="' + customIconId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Icon Name</label><input class="slide of-input of-slider-title" name="' + customIconId + '[' + newNum + '][title]" id="' + customIconId + '_' + newNum + '_slide_title" value=""><label>Icon Image URL</label><input class="slide of-input" name="' + customIconId + '[' + newNum + '][url]" id="' + customIconId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + customIconId + '_' + newNum + '" rel="'+customIconInt+'">Upload</span><span class="button mlu_remove_button hide" id="reset_' + customIconId + '_' + newNum + '" title="' + customIconId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><label>Icon Link URL</label><input class="slide of-input" name="' + customIconId + '[' + newNum + '][link]" id="' + customIconId + '_' + newNum + '_slide_link" value=""><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
		
		customIconsContainer.append(newCustomIcon);
		var nCustomIcons = customIconsContainer.find('.temphide');
		nCustomIcons.fadeIn('fast', function() {
			$(this).removeClass('temphide');
		});
