<?php
/*
Template Name: Contact - Half Right
*/
?>
<?php get_header(); ?>
        ...
        <?php get_template_part( 'include/content', 'head' ); if (have_posts()) : while (have_posts()) : the_post(); ?>
                    ...
                    <div class="col_half entry_content nobottommargin">
                        ...
                        $mapheight = is_numeric( get_post_meta(get_the_ID(), 'semi_page_contact_mheight', true) ) ? get_post_meta(get_the_ID(), 'semi_page_contact_mheight', true) : 250;
                        
                        $recaptchatrue = get_post_meta(get_the_ID(), 'semi_page_contact_recaptcha', true);
                        
                        if( $mapview != 1 ):
                        
                        ?>
                        
                        <div style="height: <?php echo $mapheight; ?>px; margin-bottom: 30px;">
                                    ...
                                    <div id="recaptcha_widget" style="display:none" class="recaptcha_widget clearfix">
                                        ...
                                        <div class="col_half col_last nobottommargin">
                                    		...
                                    		<div class="recaptcha_input nomargin">
                                    			<label class="recaptcha_only_if_image nomargin" for="recaptcha_response_field"><?php _e( 'Enter the words:', 'coworker' ); ?></label>
